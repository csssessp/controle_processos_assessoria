...
export const UserManagement = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const userData: User = {
      ...
      ggcon_ver_produtividade_analise: formData.get('ggcon_ver_produtividade_analise') === 'on',
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md max-h-[90vh] flex flex-col overflow-hidden">
            ...
            <div className="p-6 space-y-4 overflow-y-auto">
              ...
              <div className="pt-2 border-t border-slate-100 mt-2 space-y-2">
                ...
                <label className="flex items-center gap-2 text-sm text-slate-700 cursor-pointer select-none pt-1">
                  <input type="checkbox" name="ggcon_ver_produtividade_analise" defaultChecked={editingUser?.ggcon_ver_produtividade_analise ?? false} className="w-4 h-4 text-purple-600 rounded border-gray-300 focus:ring-purple-500"/>
                  <span className="flex items-center gap-1 text-purple-700 font-medium">Pode ver Produtividade da Análise</span>
                </label>
                <p className="text-[10px] text-slate-400">Usuários com esta permissão enxergam a aba "Produtividade" dentro de "Análise Processo GGCON", com o consolidado mensal de processos analisados por técnico. Administradores sempre podem, independente desta marcação.</p>
              </div>
            </div>
